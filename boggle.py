...
class Boggle():
    ...
    def __init__(self):
        ...
        self.words = self.read_dict("words.txt")  #open a dict that is called file "words.txt"

    def read_dict(self, dict_path): 
        """Read and return all words in dictionary."""

        dict_file = open(dict_path)
        words = [w.strip() for w in dict_file] #strip the white spaces l & r of word for each word in dict and return them.
        dict_file.close()
        return words
